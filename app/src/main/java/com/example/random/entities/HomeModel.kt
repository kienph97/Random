...
data class HomeModel(
    ...
    fun getListItem(context: Context) = arrayListOf(
        ...
        HomeModel(id = 2, icon = R.drawable.ic_yesorno, title = context.getString(R.string.yes_or_no_label)),
        HomeModel(id = 3, icon = R.drawable.ic_choose_item, title = context.getString(R.string.choose_item_label)),
        HomeModel(id = 4, icon = R.drawable.ic_leaf, title = context.getString(R.string.RPS_label)),
        ...
        HomeModel(id = 7, icon = R.drawable.ic_dice, title = context.getString(R.string.dice_roller_label))
    )
}
